...
public class ConceptTokenExtractor
{
	...
	return extract(node, false, false);
    }
    
    public static List<String> extract(ASTNode node, boolean filter_stopwords, boolean filter_short_long_words) {
	...
	for (CodeToken code_tk : code_tk_list) {
	    ...
	    List<String> cw_list = ConceptWordExtractor.extract(code_tk_text, filter_stopwords, filter_short_long_words);
